        ...
        <div class="shop-menu ml-0 mr-0">
          <div class="row">
            ...
            <div class="col-sm-4">
              ...
              <div class="form-group">
                <select name="type" class="form-control">
                  <option selected="selected" value="">Range</option>
              ...
              <span class="input-group-btn "><button name="btn" type="submit" class="btn-sm btn btn-color">Search</button></span>
            </div>
          </form>
            ...
            <div class="col-sm-4">
                    <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST">
                      <div class="input-group">
                        <input name="search" type="text" placeholder="product_name/brand/category" class="form-control"><span class="input-group-btn"><button name="button" type="submit" class="btn btn-color">Search</button></span>
                      </div>
                    </form>
                  </div>
                </div>
        ...
        <div class="row">
          ...
          if (isset($_POST['button'])) {
            ...
            if (empty($search)) {
              ...
              $sql = "SELECT * FROM product_info WHERE product_name='$search' || category='$search' || brand='$search' ";
            }
            ...
            if (empty($type)) {
              ...
              $sql = "SELECT * FROM product_info WHERE cell_prize BETWEEN $min AND $max";
            }
          }else{
            $sql = 'SELECT * FROM product_info';
          }
          ...
          <div class="col-md-3 col-sm-6">
            <div class="shop-product">
              <div class="product-thumb">
                <a href="#">
                  <img src="photos/<?php echo $fdata['photo']  ?>" alt="">
                </a>
                <div class="product-overlay"><a href="shop-single.php?id=<?php echo $fdata['id']; echo ':'; echo $fdata['brand']?>" class="btn btn-color-out btn-sm">View Product<i class="ti-bag"></i></a>
                </div>
              </div>
              <div class="product-info">
                <h4 class="upper"><a href="#"><?php echo $fdata['product_name'] ?></a></h4><span>Regular Prize : <del><?php echo $fdata['regular_prize'] ?></del></span><br><span>Cell Prize : <?php echo $fdata['cell_prize'] ?></span>
