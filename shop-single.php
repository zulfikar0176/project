...
<head>
  ...
  <body>
    ...
    <section>
      <?php 
        $id = $_GET['id'];
        list($sm, $br ) = explode(':', $id);
        $sql = "SELECT * FROM product_info WHERE id='$sm'";
          ...
          <div class="row">
            ...
            <div class="col-md-5 col-md-offset-1">
              <div class="title mt-0">
                <h2><?php echo $fdata['product_name'] ?><span class="red-dot"></span></h2>
                <p class="m-0">Free Shipping Worldwide</p>
              </div>
              <div class="single-product-price">
                <div class="row">
                  <div class="col-xs-6">
                    <h3><del><?php echo $fdata['regular_prize'] ?></del><span><?php echo $fdata['cell_prize'] ?></span></h3>
                  </div>
              ...
              <div class="single-product-list">
                <ul>
                  ...
                  <li><span>Category:</span><a href="#"><?php echo $fdata['category'] ?></a>
                  <li><span>Brand:</span><a href="#"><?php echo $fdata['brand'] ?></a>
                  </li>
                  <li><span>Tags:</span><a href="#">Outfit</a>-<a href="#"><?php echo $fdata['tag'] ?></a>
                  </li>
                </ul>
              </div>
            </div>
        ...
        <div class="product-tabs">
          ...
          <div class="tab-content">
            <div id="first-tab" role="tabpanel" class="tab-pane active">
              ...
              <p><?php echo $fdata['discription'] ?></p>
            </div>
        ...
        <div class="related-products">
          ...
          <div class="row">
            ...
            <?php 
              ...
              $sql = "SELECT * FROM product_info WHERE brand='$br' LIMIT 4";
              $data = $connection -> query($sql);
            ...
            <div class="col-md-3 col-sm-6">
              <div class="shop-product">
                <div class="product-thumb">
                  <a href="shop-single.php?id=<?php echo $fdata['id']; echo ':'; echo $fdata['brand']?>">
                    <img src="photos/<?php echo $fdata['photo']; ?>" alt="">
                  </a>
                </div>
                <div class="product-info">
                  <h4 class="upper"><a href="#"><?php echo $fdata['product_name']; ?></a></h4><span><?php echo $fdata['cell_prize']; ?></span>
